...
// Functions: 14 readable of 17 total (state-changing functions are omitted — this SDK does not sign).
//
// Regenerate with:
...
/// Typed read bindings for Flare's `IPChainStakeMirror` contract.
///
