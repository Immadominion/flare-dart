...
// Contract: IIVPToken
// Functions: 25 readable of 40 total (state-changing functions are omitted — this SDK does not sign).
//
// Regenerate with:
...
/// Typed read bindings for Flare's `IIVPToken` contract.
///
