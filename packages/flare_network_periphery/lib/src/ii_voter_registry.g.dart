...
// Functions: 23 — 20 readable via eth_call, 3 requiring a
...
/// Typed bindings for Flare's `IIVoterRegistry` contract.
///
...
class IIVoterRegistryContract {
  ...
  /// ABI descriptor for `createSigningPolicySnapshot(uint256)`.
  static final AbiFunction createSigningPolicySnapshotFn = AbiFunction(
  ...
  /// ABI descriptor for `setNewSigningPolicyInitializationStartBlockNumber(uint256)`.
  static final AbiFunction setNewSigningPolicyInitializationStartBlockNumberFn =
      AbiFunction(
  ...
  /// Builds an unsigned `createSigningPolicySnapshot(uint256)`
  /// transaction.
  ///
  ...
  TransactionRequest createSigningPolicySnapshotTx(
    BigInt rewardEpochId, {
    EthAddress? from,
  }) => TransactionRequest.callFunction(
    to: address,
    function: createSigningPolicySnapshotFn,
    args: [rewardEpochId],
    from: from,
  );
  ...
  /// Builds an unsigned `setNewSigningPolicyInitializationStartBlockNumber(uint256)`
  /// transaction.
  ///
  /// Declared `nonpayable` in Solidity, so it changes state and
  /// must be signed. This package holds no keys: pass the
  ...
  /// gas and fees, then hand
  /// [TransactionRequest.toWalletJson] to a wallet.
  TransactionRequest setNewSigningPolicyInitializationStartBlockNumberTx(
    BigInt rewardEpochId, {
    EthAddress? from,
  }) => TransactionRequest.callFunction(
    to: address,
    function: setNewSigningPolicyInitializationStartBlockNumberFn,
    args: [rewardEpochId],
    from: from,
  );
