...
// Functions: 12 readable of 12 total (state-changing functions are omitted — this SDK does not sign).
//
// Regenerate with:
...
/// Typed read bindings for Flare's `IFlareAssetRegistry` contract.
///
