...
// Functions: 10 readable of 18 total (state-changing functions are omitted — this SDK does not sign).
//
// Regenerate with:
...
/// Typed read bindings for Flare's `IIPollingManagementGroup` contract.
///
...
class IIPollingManagementGroupContract {
  ...
  const IIPollingManagementGroupContract({required this.client, required this.address});
  ...
  static Future<IIPollingManagementGroupContract> resolve(
    ...
    String registryName = 'IIPollingManagementGroup',
  }) async {
