...
class IIFlareSystemsCalculatorContract {
  ...
  const IIFlareSystemsCalculatorContract({required this.client, required this.address});
  ...
  Future<BigInt> calculateBurnFactorPPM(BigInt rewardEpochId, EthAddress voter) async {
